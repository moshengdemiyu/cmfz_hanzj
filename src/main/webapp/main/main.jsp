...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#">欢迎:<span class="text-info">${admin.username}</span></a></li>
                    <li><a href="${path}/admin/logout">退出登录<span class="glyphicon glyphicon-log-in" aria-hidden="true"></span></a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
    </nav>
    ...
    <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><button class="btn btn-info"><a href="javascript:$('#mainId').load('${path}/user/user.jsp')">用户信息</a></button></li><br>
                                    <li>
                                        <button type="button" class="btn btn-info">
                                            <a href="javascript:$('#mainId').load('${path}/echarts/echarts.jsp')">用户统计</a>
                                        </button>
                                    </li><br>
                                    <li>
                                        <button type="button" class="btn btn-info">
                                            <a href="javascript:$('#mainId').load('${path}/echarts/china.jsp')">用户分布</a>
                                        </button>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="col-md-10" id="mainId">
            ...
            <!--页脚-->
            <center><div class="panel-footer">@百知教育 hanzj@qq.com</div></center>
