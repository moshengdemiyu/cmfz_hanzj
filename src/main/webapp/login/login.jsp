    ...
    <script type="application/javascript">
        $(function () {
            ...
            $.extend($.validator.messages, {
                required: "<span style='color:cadetblue'>这是必填字段</span>",
                minlength: $.validator.format("最少要输入4个字符"),
            });
                ...
                if(isok){
                    $.ajax({
                        ...
                        success: function (data) {
                            if(data.success!=200){
                                // 展示错误信息
                                $("#msgDiv").html("<p style='color:crimson'>"+data.message+"</p>")
                            }else{
                                // 页面跳转
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" minlength="4" name="username" placeholder="请输入用户名..." class="username form-control" required id="username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="password">Password</label>
                                <input type="password" minlength="4" name="password" placeholder="请输入密码..." class="password form-control" required id="password">
                            </div>
                            <div class="form-group">
