...
public class EditorController {
    ...
    * */
    ...
    public HashMap<String, Object> editorUpload(MultipartFile photo, HttpServletRequest request){
        ...
        try {
            ...
            // 拼接网络路径 "http://localhost:8215/cmfz_hanzj/upload/editor/"+name
    ...
    public HashMap<String,Object> queryPhotos(HttpServletRequest request){
        ...
        *   "moveup_dir_path": "",
              ...
              "file_list":
        * */
        maps.put("current_url","http://localhost:8215/cmfz_hanzj/upload/editor/");
